...
class TopicQrcodeForm extends Model
{
    public $store_id;
    public $goods_id;
    public $user_id;
    ...
    public function search()
    {
        ...
        $goods_pic_save_name = md5("v=1.6.2&goods_id={$goods->id}&goods_name={$goods->title}&store_name={$store->name}&user_id={$this->user_id}&goods_pic_url={$goods_pic_url}") . '.jpg';
...
//        var_dump($namewitch[2]);die();
        ...
        // 商品价格钱币符
        //$editor->text($goods_qrcode, '介绍', 15, 30, 962, new Color('#ff5c5c'), $font_path, 0);
        //加商品价格
        //$editor->text($goods_qrcode, $goods->content, 29, 48, 950, new Color('#ff5c5c'), $font_path, 0);
