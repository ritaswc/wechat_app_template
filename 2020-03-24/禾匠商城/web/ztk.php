...
require dianc_ROOT . '/addons/lywywl_ztk/admin/common/bootstrap.sys.inc.php';
require dianc_ROOT . '/addons/lywywl_ztk/admin/common/template.func.php';
require dianc_ROOT . '/addons/lywywl_ztk/admin/common/common.func.php';
...
function _forward($c, $a) {
    $file = dianc_ROOT . '/addons/lywywl_ztk/admin/source/' . $c . '/' . $a . '.ctrl.php';
    if (!file_exists($file)) {
        //todo:修改的地方
        header('location:' . url('site/entry/home', array('m' => 'lywywl_ztk')));
        exit();
    }
    return $file;
}
